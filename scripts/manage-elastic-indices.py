...
# Simple python script for automatically configuring elasticsearch indices for all clusters that are defined in salt pillar
# Aims to complement state modules, though should be usable as standalone tool with minimal modification
